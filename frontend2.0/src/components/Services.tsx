...
const services = [
  {
    ...
    description: "Seamlessly migrate your existing infrastructure to the cloud with minimal disruption.",
    icon: (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="section-subtitle">
            Comprehensive cloud solutions to help your business thrive in the digital age
          </p>
        </motion.div>
