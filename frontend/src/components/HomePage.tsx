            ...
            <div className="relative z-10 py-16 sm:py-20 lg:py-24 mx-auto text-center">
              ...
              >
                <div className="relative">
                  ...
                  {/* Floating Mobile Interfaces */}
                  <motion.img
                    src="/images/mobile-left.png"
                    alt="Mobile Interface Left"
                    className="absolute -left-16 top-1/4 w-64 rounded-xl shadow-lg hidden lg:block"
                    animate={{ y: [0, -12, 0] }}
                    transition={{
                      duration: 4,
                      repeat: Infinity,
                  ...
                  <motion.img
                    src="/images/mobile-right.png"
                    alt="Mobile Interface Right"
                    className="absolute -right-16 bottom-1/4 w-64 rounded-xl shadow-lg hidden lg:block"
                    animate={{ y: [0, 12, 0] }}
                    transition={{
                      duration: 4,
                      repeat: Infinity,
                  ...
                  <motion.img
                    src="/envelope.svg"
                    alt="Paper Plane"
                    className="absolute -left-8 -top-8 w-12 h-12 hidden lg:block"
                    animate={{ 
                      x: [0, 20, 0],
                      y: [0, -20, 0],
                      rotate: [0, -15, 0]
                  ...
                  <motion.img
                    src="/envelope.svg"
                    alt="Paper Plane"
                    className="absolute -right-8 -bottom-8 w-12 h-12 hidden lg:block"
                    animate={{ 
                      x: [0, -20, 0],
                      y: [0, 20, 0],
                      rotate: [0, 15, 0]
